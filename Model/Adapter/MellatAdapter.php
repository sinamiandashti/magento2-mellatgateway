 ...
 */
namespace MagentoFarsi\Mellat\Model\Adapter;
...
use MagentoFarsi\Mellat\Helper\Data as MellatLib;
...
class MellatAdapter
{
    ...
    public function generate(array $params = [])
    {
        try {
            ...
            return $this->mellatLib->getOrderPlaceRedirectUrl();
        } catch (\Exception $e) {
            return null;
        }
    }
